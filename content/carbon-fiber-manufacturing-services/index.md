...
schema:
  faq:
    - question: "What carbon fiber manufacturing services do you offer end to end?"
      answer: "We provide a complete in-house chain: engineering review, mold making, prepreg and hand layup, vacuum bagging, autoclave curing, 3-axis and 5-axis CNC machining, bonding, surface finishing and CMM inspection. Keeping every step under one roof protects tolerances, lead times and traceability for customers in the US, Europe and Australia."
    - question: "Can you build production tooling as part of the service?"
      answer: "Yes. Our mold making service designs and CNC-machines aluminum and steel production tools, plus composite and soft tooling for prototypes. Every mold is validated with a first-article before release so that downstream laminating and trimming hold the geometry your program requires."
    - question: "Which curing method do you recommend for structural parts?"
      answer: "For aerospace-grade and high-performance structural laminates we recommend prepreg combined with autoclave curing at roughly 6 to 7 bar, which drives void content below one percent and delivers the mechanical properties on your print. Vacuum bag oven curing is a lower-cost option for non-critical industrial components."
    - question: "Do your carbon fiber manufacturing services include CNC trimming?"
      answer: "They do. We treat CNC machining as a first-class process with dedicated 3-axis and 5-axis centers, diamond-coated tooling and dust extraction. Critical holes, pockets and contoured edges are machined to plus or minus 0.05 mm and referenced to molded datum faces for repeatable inspection."
    - question: "How do you support prototyping before a production order?"
      answer: "Through our prototyping services we build parts using soft tooling or hand layup so you can validate fit and function in two to three weeks before committing to autoclave tooling. This de-risks the design and shortens the path from concept to a qualified production program."
