...
schema:
  faq:
    - question: "Quels composants en fibre de carbone fabriquez-vous pour les cellules d'UAV ?"
      answer: "Nous produisons des structures de cellule complètes, des bras et booms tubulaires, des supports moteurs usinés par CNC, et des plaques de charge utile pour les plateformes multirotor, VTOL et à voilure fixe. Chaque composant est conçu autour de son cas de charge de vol spécifique, puis fini et inspecté pour qu'il arrive prêt à l'assemblage. Nous fournissons aussi des jeux de paires appariées là où la symétrie compte pour un vol stable."
    - question: "Comment équilibrez-vous le poids et la rigidité pour les charges de vol ?"
      answer: "Nous menons une étude de stratifié qui associe chaque pièce à son chemin de charge dominant, puis nous spécifions l'orientation des fibres, le nombre de plis et l'épaisseur d'âme pour atteindre un rapport rigidité/masse cible. Cela garde la cellule légère tout en empêchant le flutter aéroélastique et la flèche du boom sous la poussée."
    - question: "La fibre de carbone peut-elle interférer avec les signaux GPS ou radio sur un drone ?"
      answer: "La fibre de carbone est conductrice électriquement et peut atténuer les RF, c'est pourquoi nous concevons des fenêtres transparentes aux EMI dans le stratifié, utilisons des charges non conductrices près des supports d'antenne, et éloignons les modules sensibles aux RF des grandes peaux conductrices continues. Si nécessaire, nous ajoutons une fine couche diélectrique sur les surfaces face aux antennes. Cela préserve le verrouillage GPS et la télémétrie sans sacrifier la performance structurelle de la cellule."
    - question: "Comment maîtrisez-vous les vibrations pour les charges utiles de gimbal et de caméra ?"
      answer: "Nous ajustons l'amortissement du stratifié et ajoutons des supports d'isolation locaux à l'interface de charge utile pour garder les caméras et les LiDAR stables. Les stratifiés symétriques réduisent les résonances déséquilibrées, et nous vérifions la réponse modale sur les prototypes par tests d'accéléromètre. Pour les drones de cartographie et de cinéma, nous collons souvent un patch d'amortissement par couche contrainte directement dans le plateau de charge utile, afin que l'imagerie reste nette et que les nuages de points restent précis pendant tout le vol."
    - question: "Soutenez-vous la cohérence des lots pour la production de flottes ?"
      answer: "Oui. Nous verrouillons l'outillage, les cycles de polymérisation et les dossiers de stratifié à la libération de production afin que chaque unité d'une série corresponde au premier article. L'inspection de premier article (FAI) plus des contrôles CMM périodiques maintiennent la dérive dimensionnelle dans les tolérances, ce qui compte quand les opérateurs maintiennent des flottes interchangeables. Si un bras endommagé est remplacé sur le terrain, le remplacement est dimensionnellement identique à la pièce d'origine."
    - question: "Quel est votre délai typique pour un programme de composants UAV ?"
      answer: "Les bras et plaques prototypes sont généralement expédiés en deux à trois semaines après la libération du plan, tandis que les lots de production suivent un calendrier récurrent convenu avec votre programme. Des options d'outillage rapide sont disponibles quand une conception doit itérer entre les campagnes d'essais en vol, et nous priorisons les reconstructions après crash pour qu'un appareil immobilisé revole sans perdre une fenêtre d'essai entière."
---

## Fabricant de composants en fibre de carbone pour UAV

TechCarbonWorks est un **fabricant de composants en fibre de carbone pour UAV** spécialisé, au service des intégrateurs de drones, des contractuels de défense et des marques d'équipements de levé aux États-Unis, en Europe et en Australie. Depuis notre fondation à Huizhou, en Chine, en 2013, nous avons bâti une réputation de livraison de structures composites prêtes au vol qui résolvent le problème le plus difficile de l'aviation sans pilote : obtenir la rigidité et la durabilité sans payer de penalty de poids qui raccourcit le temps de vol. Que vous construisiez un multirotor de portage lourd, un VTOL à longue endurance ou un quadricoptère d'inspection compact, la cellule est là où les économies de poids marginales se cumulent en gains de mission significatifs. Cette page explique comment nous concevons des pièces UAV en fibre de carbone, ce que nous pouvons produire et comment notre discipline de fabrication garde une flotte de cent unités indiscernables du premier article.
...
Les charges de vol sur un UAV sont rarement symétriques. L'accélération vers l'avant, le lacet par poussée différentielle et l'impact à l'atterrissage agissent chacun sur des axes différents. Nous modélisons les chemins de charge dominants et plaçons du ruban de carbone unidirectionnel là où la tension et la compression sont maximales, réservant le tissé pour les zones sujettes aux impacts et les zones nécessitant des propriétés équilibrées. La fraction volumique de fibres est maintenue dans une plage étroite (typiquement 55-62 pour cent) afin que les zones trop riches ou trop pauvres en résine n'apparaissent pas, les deux affaiblissant le stratifié. Nos [services de prototypage en fibre de carbone](/carbon-fiber-prototyping-services/) permettent aux équipes de valider un stratifié sur un petit lot avant de s'engager sur l'outillage.
...
Si vous spécifiez une nouvelle cellule ou refaites le sourcing d'une existante, parlez à notre desk d'ingénierie. En tant que fabricant expérimenté de composants en fibre de carbone pour UAV fondé en 2013, nous pouvons mener vos plans du prototype à la production validée avec la documentation que votre équipe qualité exige. Contactez-nous directement à **hank@techcarbonworks.com** pour demander un devis, partager des fichiers STEP ou planifier une revue de conception de stratifié. Vous pouvez aussi explorer notre [site TechCarbonWorks](https://techcarbonworks.com/) et notre [blog de fabrication en fibre de carbone](https://techcarbonworks.com/carbon-fiber-manufacturing-blog/) pour des articles techniques approfondis sur la conception composite UAV.
