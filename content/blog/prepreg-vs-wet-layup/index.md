---
title: "Prepreg vs Wet Layup: Choosing the Right Carbon Fiber Process"
date: 2026-07-21
draft: false
description: "Compare prepreg and wet layup carbon fiber processes on fiber volume, voids, cure method, tooling cost and cosmetic quality with a decision matrix."
tags: ["carbon fiber manufacturing", "composite process", "production methods"]
...
Need help picking the process for your next carbon fiber program? Email hank@techcarbonworks.com with your part geometry and volumes and we will recommend the lowest-risk, lowest-cost route to production.

{{< faq_accordion q1="Which process gives higher fiber volume fraction, prepreg or wet layup?" a1="Prepreg consistently achieves 58 to 65 percent fiber volume because resin is metered by the supplier and compaction pressure is high. Wet layup typically reaches 40 to 55 percent with more part-to-part variability because the operator controls resin by hand." q2="Can wet layup match prepreg quality if done carefully?" a2="It can approach prepreg for non-structural and cosmetic parts, but it rarely matches the sub-one-percent void content and consistency of autoclave-cured prepreg. Resin infusion improves wet layup quality but still trails prepreg on fiber volume and scatter." q3="Why is prepreg tooling more expensive than wet layup tooling?" a3="Prepreg cures under heat and pressure, so molds must be CNC-machined metal or high-temperature composite to hold tolerance and survive the cycle. Wet layup uses low temperature and pressure, allowing cheap fiberglass, wood, or printed molds." q4="Should we start with wet layup and switch to prepreg later?" a4="Yes, that is a common path. Wet layup is ideal for early, low-cost prototypes, then moving to prepreg once the design is frozen and volumes justify the higher mold investment delivers consistency and structural grade quality." >}}
