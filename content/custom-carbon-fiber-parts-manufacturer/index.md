...
schema:
  faq:
    - question: "What does build-to-print mean for a custom carbon fiber part?"
      answer: "Build-to-print means we manufacture exactly to your CAD and drawing, holding the datums, tolerances and surface requirements you specify. We review the file for manufacturability first, then produce a first-article part for sign-off before running production. This protects fit and function on your assembly line and removes ambiguity about who owns the geometry."
    - question: "Can you handle both prototype and production volumes?"
      answer: "Yes. As a custom carbon fiber parts manufacturer we start programs with soft-tooled or hand-laid prototypes for validation, then transition to molded production tooling for volume. Our mold shop and autoclave capacity let us scale from a few parts to recurring batches of thousands while keeping the same laminate schedule and inspection plan."
    - question: "Which fibers are available for custom parts?"
      answer: "We stock Toray T300, T700 and T800 prepreg in unidirectional and fabric forms, plus 3K twill and plain weave, forged carbon and carbon-kevlar hybrid. All material is cold-stored and lot-tracked so your custom part carries full traceability from raw prepreg through finished, inspected shipment."
    - question: "How do you protect tight tolerances on custom geometry?"
      answer: "We machine critical features on 3-axis and 5-axis centers referenced to molded datum faces, holding plus or minus 0.05 mm. Molded surfaces carry the nominal shape while drilled holes, pockets and contoured edges are machined, then verified on a CMM. This split of molded versus machined tolerance keeps custom parts assembly-ready."
    - question: "What industries do your custom carbon parts serve?"
      answer: "We build for UAV and drone systems, aerospace secondary structures, motorsport aero devices, medical equipment, industrial robotics and premium consumer goods. Each sector has different documentation needs, and our ISO 9001 system supplies the material certificates, build records and inspection reports those programs require."
